...
* **Environment:** Jupyter Notebook for end-to-end exploratory data analysis and modeling
...
```bash
git clone [https://github.com/Christo1011/data-analytics-portfolio.git](https://github.com/Christo1011/data-analytics-portfolio.git)
...
├── reports/             # Visualizations & screenshots
│   ├── transaction_distribution.png
│   ├── logistic_top_features.png
│   └── classifier_top_features.png
